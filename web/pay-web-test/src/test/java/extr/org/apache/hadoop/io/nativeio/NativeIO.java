 ...
 */
package extr.org.apache.hadoop.io.nativeio;
...
public class NativeIO {
    ...
    private static final Map<Long, CachedUid> uidCache = new ConcurrentHashMap<>();
     ...
     *
     * @param name
     *         the full principal name containing the domain
