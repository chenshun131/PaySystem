	...
	<div clazz="queryConditions">
		...
		<table clazz="resaullist_head">
			...
			<strong> &nbsp; </strong>
				...
				<a  id="exportExecl" href="memberPayTransfer_transferExportExcel.action?beginDate=${beginDate }&endDate=${endDate }&trxNo=${trxNo}" onclick="return exportExcel();" clazz="exportBtn">导出EXCEL</a>
			</p>
		</table>
		<div clazz="clear"></div>
		</div>
