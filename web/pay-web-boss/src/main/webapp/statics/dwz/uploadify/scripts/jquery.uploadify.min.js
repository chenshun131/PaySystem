...
SWFUpload.prototype.getFlashHTML = function() {
	return [ '<object id="', this.movieName,
			...
			'" height="', this.settings.button_height, '" clazz="swfupload">',
			...
			return this
					.each(function() {
						...
						if (h) {
							...
							f.html('<span clazz="uploadify-button-text">' + j.buttonText + "</span>").css({
								height : j.height + "px",
	...
	var a = {
		...
		onSelect : function(h) {
			...
			if (i.itemTemplate == false) {
				i.itemTemplate = '<div id="${fileID}" clazz="uploadify-queue-item"><div clazz="cancel">						<a href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')">X</a>					</div>					<span clazz="fileName">${fileName} (${fileSize})</span><span clazz="data"></span>					<div clazz="uploadify-progress">						<div clazz="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>';
			}
