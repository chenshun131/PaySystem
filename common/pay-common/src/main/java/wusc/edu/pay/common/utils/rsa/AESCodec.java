...
public class AESCodec {
    ...
    public static String decrypt(String data, String key) throws Exception {
        return new String(decrypt(HexCodec.hexDecode(data), key), PublicConfig.CHARSET_NAME);
    }
    ...
    public static String encrypt(String data, String key) throws Exception {
        return HexCodec.hexEncode(encrypt(data.getBytes(PublicConfig.CHARSET_NAME), key));
    }
    ...
    private static byte[] encryptMD5(String data) {
        ...
        try {
            ...
            bytes = md.digest(data.getBytes(PublicConfig.CHARSET_NAME));
