...
public enum TrxTypeEnum {
    ...
    public static TrxTypeEnum getEnum(int value) {
        ...
        for (TrxTypeEnum anEnumAry : enumAry) {
    ...
    public static List toListForPayWayEnum() {
        ...
        List list = new ArrayList();
        // 支付类型
        int value[] = {6001, 6002, 6004, 6005, 3001};
        for (TrxTypeEnum anAry : ary) {
            int val = anAry.getValue();
            for (int v : value) {
                if (val == v) {
    ...
    public static List toListForCalOther() {
        ...
        List list = new ArrayList();
        // 计费其他类型
        int value[] = {2001, 4001, 4002, 4003, 4004, 4005, 5001, 5002};
        for (TrxTypeEnum anAry : ary) {
            int val = anAry.getValue();
            for (int v : value) {
                if (val == v) {
    ...
    public static List toListForOnline() {
        TrxTypeEnum[] ary = TrxTypeEnum.values();
        List list = new ArrayList();
        int value[] = {2001, 3001, 4001, 4002, 4003, 4004, 4005, 5002, 5004, 6001, 6002, 6005, 7004, 8002, 8003,
                9001, 5001, 5003}; //在线交易类型
        for (TrxTypeEnum anAry : ary) {
            int val = anAry.getValue();
            for (int v : value) {
                if (val == v) {
    ...
    public static List toListForPos() {
        ...
        List list = new ArrayList();
        // POS交易类型
        int value[] = {4006, 4007, 4008, 4009, 4010, 4013, 6006, 6007, 6008, 6009, 6010, 7004, 8002, 8003, 5001, 5003};
