...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
     ...
     * @param interModel
     *         区间的模式，取值 : <br/>
     *         LEFT_OPEN_RIGHT_OPEN <br/>
     *         LEFT_CLOSE_RIGHT_OPEN <br/>
     *         LEFT_OPEN_RIGHT_CLOSE <br/>
     *         LEFT_CLOSE_RIGHT_CLOSE <br/>
     * @param compModel
     *         比较的模式，取值 : <br/>
     *         COMP_MODEL_DATE 只比较日期，不比较时间 <br/>
     *         COMP_MODEL_TIME 只比较时间，不比较日期 <br/>
     *         COMP_MODEL_DATETIME 比较日期，也比较时间 <br/>
     * @return
     */
    ...
    public static Date getMinTime(Date dt) {
        return DateUtils.getDateByStr(DateUtils.formatDate(dt, "yyyy-MM-dd"));
    }
    ...
    public static long getDateDiff(Date date1, Date date2) {
        ...
        return (date1.getTime() - date2.getTime()) / (24 * 60 * 60 * 1000) > 0 ?
                (date1.getTime() - date2.getTime()) / (24 * 60 * 60 * 1000) :
                (date2.getTime() - date1.getTime()) / (24 * 60 * 60 * 1000);
    }
