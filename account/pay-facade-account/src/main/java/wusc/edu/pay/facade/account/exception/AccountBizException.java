...
public class AccountBizException extends BizException {
    ...
    public static final AccountBizException ACCOUNT_AMOUNT_LESS_THAN_SETTLE_AMOUNT = new AccountBizException(20080111, "结算账户余额 小于不可用余额，不能结算");

    public static final AccountBizException ACCOUNT_POS_TRXTYPE_INVALID = new AccountBizException(20080112, "POS交易类型无效");

    public static final AccountBizException ACCOUNT_CUSTOMER_WITHDRAWAMOUNT_BIGGER_BALANCE = new AccountBizException(20080113, "会员提现金额大于可用金额");
