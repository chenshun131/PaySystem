...
//				}
    ...
    public int test() throws InterruptedException {
        String str = "http://www.scpta.gov.cn/UserPay/BCallback" +
                ".asp?p1_MerId=10000216814&r0_Cmd=Buy&r1_Code=1&r2_TrxId=418126905762402E&r3_Amt=100.0&r4_Cur=RMB" +
                "&r5_Pid=2041&r6_Order=BM2041O243605O2184995OZ&r8_MP=&r9_BType=2&ra_Details=&rb_SplitStatus=SPLITED" +
                "&rc_SourceFee=&rd_TargetFee=&rq_SourceFee=0.0&rq_TargetFee=0.0&rb_BankId=CEB-NET&ro_BankOrderId" +
                "=2014595416120928&rp_PayDate=20120928172639&peo_checkInDate=&peo_checkOutDate=&hmac" +
                "=85b92bb7dc10d9d52189008fe1918f45";
        for (int i = 0; i < 10; i++) {
