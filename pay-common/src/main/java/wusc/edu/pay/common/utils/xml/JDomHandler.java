...
public class JDomHandler {
    ...
    public Document addNodeVaueWithCheckAllPathNodes(String parentElementPath, String elementName, String value)
     ...
     * @throws JDOMException
     */
    public Document setNodeValues(String path, String nodeName, String value) throws JDOMException,
            JDomHandlerException {
    ...
    public Document loadXmlByString(String xml) throws JDOMException, IOException {
        ...
        try {
            ...
            // 匹配标签结束符
            Pattern p1 = Pattern.compile("</\\w+\\p{Punct}?\\w*>");
